...
class ServiciosMasculinosController extends Controller
{
    /**
     ...
     */
    public function IndividualesMasculino()
    {
        ...
        return view('serviciosMasculinos.individuales', compact('individuales'));
    }
