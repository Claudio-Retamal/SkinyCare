            ...
            <div class="col-md-9">
                <div class="row">
                        ...
                        <div class="product_detail_feature_img hizoom hi2" style="width: 400px; height: 400px;">
                            <div class="hizoom hi2" style="width: 400px; height: 400px;">
                                <div class="small" style="width: 400px; height: 400px;">
                                    <div class="magnifier"
                                        style="width: 200px; height: 200px; opacity: 0.7; background: rgb(255, 255, 255); top: 0px; left: 200px; display: none;">
                                    </div><img src="images/it_service/1.jpg" alt="#"
                                        style="width: 400px; height: 400px;">
                                </div>
                                <div class="big" style="width: 400px; height: 400px; right: -420px; display: none;">
                                    <img src="images/it_service/1.jpg" alt="#"
                                        style="width: 800px; height: 800px; top: 0px; left: -400px;"></div>
                            </div>
                            <div class="small" style="width: 400px; height: 400px;">
                                <div class="magnifier"
                                    style="width: 200px; height: 200px; opacity: 0.7; background: rgb(255, 255, 255);">
                                </div><img src="images/it_service/1.jpg" alt="#"
                                    style="width: 400px; height: 400px;">
                            </div>
                            <div class="big" style="width: 400px; height: 400px; right: -420px;"><img
                                    src="images/it_service/1.jpg" alt="#" style="width: 800px; height: 800px;">
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-6 col-lg-12 col-md-12 product_detail_side detail_style1">
                        ...
                        <div class="product-detail-side"> <span><del>$25.00</del></span><span
                                class="new-price">$20.00</span> <span class="rating"> <i class="fa fa-star"
                                    ...
                                    <div id="description" class="tab-pane active">
                                        <div class="product_desc">
                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas ac
                                                elementum elit. Morbi eu arcu ipsum. Aliquam lobortis accumsan quam ac
                                                convallis.
                                                Fusce elit mauris, aliquet at odio vel, convallis vehicula nisi. Morbi
                                                vitae porttitor dolor. Integer eget metus sem. Nam venenatis mauris vel
                                                leo pulvinar,
                                                id rutrum dui varius. Nunc ac varius quam, non convallis magna. Donec
                                                suscipit commodo dapibus.<br>
                                                <br>
                                                Vestibulum et ullamcorper ligula. Morbi bibendum tempor rutrum.
                                                Pelle tesque auctor purus id molestie ornare.Donec eu lobortis risus.
                                                Pellentesque sed aliquam lorem. Praesent pulvinar lorem vel mauris
                                                ultrices posuere.
                                                Phasellus elit ex, gravida a semper ut, venenatis vitae diam. Nullam
                                                eget leo massa. Aenean eu consequat arcu, vitae scelerisque quam.
                                                Suspendisse risus turpis,
                                        ...
                                        <div class="product_review">
                                            ...
                                            <div class="commant-text row">
                                                ...
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <h5>David</h5>
                                                    <p><span class="c_date">March 2, 2018</span> | <span><a
                                            ...
                                            <div class="commant-text row">
                                                <div class="col-lg-2 col-md-2 col-sm-4">
                                                    <div class="profile"> <img class="img-responsive"
                                                            src="images/it_service/client2.png" alt="#"> </div>
                                                </div>
                                                <div class="col-lg-10 col-md-10 col-sm-8">
                                                    <h5>Jack</h5>
                                                    <p><span class="c_date">March 2, 2018</span> | <span><a
                                                    ...
                                                    <p class="msg">Nunc augue purus, posuere in accumsan sodales ac,
                                                        ...
                                                        placerat mattis. Praesent mollis justo felis, accumsan faucibus
                                                        mi maximus et. Nam hendrerit mauris id scelerisque placerat. Nam
                                                        vitae imperdiet turpis</p>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="full review_bt_section">
                                                        <div class="float-right"> <a class="btn sqaure_bt"
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_30_all">
                        <div class="product_list">
                            <div class="product_img"> <img class="img-responsive" src="images/it_service/4.jpg"
                                    alt=""> </div>
                            <div class="product_detail_btm">
                                ...
                                <div class="product_price">
                                    <p><span class="old_price">$15.00</span> – <span class="new_price">$25.00</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_30_all">
                        <div class="product_list">
                            <div class="product_img"> <img class="img-responsive" src="images/it_service/5.jpg"
                                    alt=""> </div>
                            <div class="product_detail_btm">
                                <div class="center">
                                    <h4><a href="it_shop_detail.html">Norton Internet Security</a></h4>
                    ...
                    <div class="col-md-4 col-sm-6 col-xs-12 margin_bottom_30_all">
                        <div class="product_list">
                            <div class="product_img"> <img class="img-responsive" src="images/it_service/6.jpg"
                                    alt=""> </div>
                            <div class="product_detail_btm">
                                <div class="center">
